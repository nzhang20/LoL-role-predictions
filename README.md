...
A UCSD DSC80 project predicting the role of League of Legends players based on their in-game statistics.
...
## Data Cleaning
As we are basing this prediction model off of similar data used in a previous project, we performed the same data cleaning steps. Our exploratory data analysis on this dataset can be found [here](https://charissehao.github.io/LoL-role-impact/).
